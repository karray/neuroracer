...
children+=("$!")
export GZ_SIM_RESOURCE_PATH="/workspace/.ros2/install/neuroracer_sim/share/neuroracer_sim/models${GZ_SIM_RESOURCE_PATH:+:$GZ_SIM_RESOURCE_PATH}"
gz sim -g --gui-config /workspace/.ros2/install/neuroracer_sim/share/neuroracer_sim/config/gui.config &
children+=("$!")
